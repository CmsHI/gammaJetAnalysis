...
void drawPtDependence(TString dirName="nominal", int prodDate=20131021, int jetPtCut=30, TString fNameSuffix = "", TString outNameSuffix = "");

void drawPtDependence(TString dirName, int prodDate, int jetPtCut, TString fNameSuffix, TString outNameSuffix) {
  TH1::SetDefaultSumw2();
          ...
          if ( histFile[icoll][ipt]->IsZombie()  == false ) {
              ...
              if ( ( icoll == kHIDATA) ||  (icoll == kHIMC) ) {
                  for ( int icent = 1; icent <= nCentBinHI ; icent++ ) {
                      ...
                      std::cout << " Getting histogram : " << Form("xjg_icent%d_final", centBinHI[icent] ) << std::endl;
                      hJetPt[icoll][icent][ipt] = (TH1D*)histFile[icoll][ipt]->Get(Form("jetPt_icent%d_final", centBinHI[icent] ) );
                      std::cout << " Getting histogram : " << Form("jetPt_icent%d_final", centBinHI[icent] ) << std::endl;
                      hJetPtIaaBin[icoll][icent][ipt] = (TH1D*)histFile[icoll][ipt]->Get(Form("jetPtForIaa_icent%d_final", centBinHI[icent] ) );
                      std::cout << " Getting histogram : " << Form("jetPtForIaa_icent%d_final", centBinHI[icent] ) << std::endl;
                      hDphi[icoll][icent][ipt]  = (TH1D*)histFile[icoll][ipt]->Get(Form("jetDphi_icent%d_final", centBinHI[icent] ) ) ;
                      std::cout << " Getting histogram : " << Form("jetDphi_icent%d_final", centBinHI[icent])<< std::endl;
                      hEta[icoll][icent][ipt]  = (TH1D*)histFile[icoll][ipt]->Get(Form("etaJg_icent%d_final", centBinHI[icent] ) ) ;
                      std::cout << " Getting histogram : " << Form("etaJg_icent%d_final", centBinHI[icent])<< std::endl;
                  }
              }
          }
          else
  ...
  if(outNameSuffix.EqualTo("")){
      ...
      c1->SaveAs(Form("figures/pT_dependence_dphi_pp_pbpb_figure1_%s.pdf", outNameSuffix.Data()));
      c1->SaveAs(Form("figures/pT_dependence_dphi_pp_pbpb_figure1_%s.gif", outNameSuffix.Data()));
  }
  ...
  if(outNameSuffix.EqualTo("")){
      ...
      c2->SaveAs(Form("figures/pT_dependence_jetPt_pp_pbpb_figure1_%s.pdf", outNameSuffix.Data()));
      c2->SaveAs(Form("figures/pT_dependence_jetPt_pp_pbpb_figure1_%s.gif", outNameSuffix.Data()));
  }
  ...
  if(outNameSuffix.EqualTo("")) {
      ...
      c21->SaveAs(Form("figures/pT_dependence_jetPt_pp_pbpb_figure2_%s.pdf", outNameSuffix.Data()));
      c21->SaveAs(Form("figures/pT_dependence_jetPt_pp_pbpb_figure2_%s.gif", outNameSuffix.Data()));
  }
  ...
  if(outNameSuffix.EqualTo("")) {
      ...
      c3->SaveAs(Form("figures/pT_dependence_xjg_pp_pbpb_figure1_%s.pdf", outNameSuffix.Data()));
      c3->SaveAs(Form("figures/pT_dependence_xjg_pp_pbpb_figure1_%s.gif", outNameSuffix.Data()));
  }
  ...
  if(outNameSuffix.EqualTo("")){
      ...
      c31->SaveAs(Form("figures/pT_dependence_xjg_pp_pbpb_figure2_%s.pdf", outNameSuffix.Data()));
      c31->SaveAs(Form("figures/pT_dependence_xjg_pp_pbpb_figure2_%s.gif", outNameSuffix.Data()));
  }
  ...
  if(outNameSuffix.EqualTo("")){
      ...
      c_rjg->SaveAs(Form("figures/pT_dependence_rjg_pp_pbpb_figure1_%s.pdf", outNameSuffix.Data()));
      c_rjg->SaveAs(Form("figures/pT_dependence_rjg_pp_pbpb_figure1_%s.gif", outNameSuffix.Data()));
  }
